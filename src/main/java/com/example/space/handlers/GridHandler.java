...
/**
 * Handles rendering of the background grid for the simulation.
 * <p>
 * The grid dynamically adjusts its spacing and opacity based on the zoom level
 * of the {@link Camera}, ensuring visibility across different scales.
 * It also draws the X and Y axes for reference.
 */
public class GridHandler {

    /**
     * Draws a dynamic grid on the given {@link GraphicsContext}.
     *
     * @param gc  the graphics context used for rendering
     * @param w   the width of the canvas
     * @param h   the height of the canvas
     * @param cam the active camera, used to convert between world and screen space
     */
